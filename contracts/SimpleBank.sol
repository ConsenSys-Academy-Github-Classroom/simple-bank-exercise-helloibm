...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      // 1.d Add the appropriate keyword so that this function can receive ether
    
      // 2. Users should be enrolled before they can make deposits
      require(enrolled[msg.sender] == true, "depostitor must be enrolled.");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      //    sender's balance
      msg.sender.transfer(withdrawAmount); //will revert on failure.
